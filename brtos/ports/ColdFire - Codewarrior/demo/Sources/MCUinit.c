...
void __initialize_hardware(void)
{
  ...
  ICSC1 = 0x12;                        /* Initialization of the ICS control register 1 */
  /* ICSC2: BDIV=0,RANGE=1,HGO=1,LP=0,EREFS=1,ERCLKEN=0,EREFSTEN=0 */
  ICSC2 = 0x34;                        /* Initialization of the ICS control register 2 */
...
void MCU_init(void)
{
  ...
  /* SCGC1: TPM3=1,TPM2=0,TPM1=1,ADC=1,IIC2=0,IIC1=0,SCI2=1,SCI1=0 */
  SCGC1 = 0xB2;                                      
  /* SCGC2: FLS=1,IRQ=0,KBI=1,ACMP=0,RTC=1,SPI2=0,SPI1=1 */
  SCGC2 |= (unsigned char)0x55;                               
...
void (*const vector_14)(void)  @Vferror     = teste;            /*0x00000038 -   - */
...
void (*const vector_75)(void)  @Vspi1       = Radio_Interrupt;  /*0x0000012C -   - */
...
void (*const vector_80)(void)  @Vkeyboard   = Keyboard;         /*0x00000140 3   6 */
void (*const vector_81)(void)  @Vadc        = UNASSIGNED_ISR;   /*0x00000144 -   - */
void (*const vector_82)(void)  @Vacmpx      = UNASSIGNED_ISR;   /*0x00000148 -   - */
void (*const vector_83)(void)  @Vsci2err    = serial_erro;      /*0x0000014C -   - */
void (*const vector_84)(void)  @Vsci2rx     = serial_rx;        /*0x00000150 -   - */
void (*const vector_85)(void)  @Vsci2tx     = serial_tx;        /*0x00000154 -   - */
void (*const vector_86)(void)  @Vrtc        = OSRTC;            /*0x00000158 -   - */
