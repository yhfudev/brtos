...
void __initialize_hardware(void)
{
  ...
  ICSC1 = 0x10;                        /* Initialization of the ICS control register 1 */
  /* ICSC2: BDIV=0,RANGE=1,HGO=1,LP=0,EREFS=1,ERCLKEN=0,EREFSTEN=0 */
  ICSC2 = 0x37;                        /* Initialization of the ICS control register 2 */
...
void (*const vector_75)(void)  @Vspi1       = SPI1;             /*0x0000012C -   - */
...
void (*const vector_87)(void)  @Vtpm3ch0    = Radio_Interrupt;  /*0x0000015C -   - */
