...
INT8U OSQueueCreate(OS_QUEUE *cqueue, INT16U size, BRTOSEvent **event)
{
  int i=0;
  ...
  pont_event->OSEventType = BRTOSEvent_TYPE_QUEUE;
...
INT8U OSQueuePend (BRTOSEvent *pont_event, OS_QUEUE *cqueue, INT16U timeout)
{
  INT16S i = 0;
  INT8U data;  
  INT16U time_wait = 0;
