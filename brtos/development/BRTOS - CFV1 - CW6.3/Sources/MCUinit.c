...
void MCU_init(void)
{
  ...
  /* SCGC1: TPM3=1,TPM2=1,TPM1=1,ADC=1,IIC2=0,IIC1=0,SCI2=1,SCI1=0 */
  SCGC1 = 0xF2;                                      
...
unsigned char NVPROT_INIT @0x0000040D = 0x83;
